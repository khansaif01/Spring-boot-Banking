...
import com.example.saif.repositories.AccountRepository;
import com.example.saif.repositories.TransactionRepository;
import com.example.saif.services.TransactionService;
import com.example.saif.utils.AccountInput;
import com.example.saif.utils.TransactionInput;
...
class TransactionServiceTest {
    ...
    @BeforeEach
    void setUp() {
        var sourceAccount = new Account(1L, "53-68-92", "78901234", 458.1, "Some Bank", "John","INR");
        var targetAccount = new Account(2L, "67-41-18", "48573590", 64.9, "Some Other Bank", "Major","INR");
