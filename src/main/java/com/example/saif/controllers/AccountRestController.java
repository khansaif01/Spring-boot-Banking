package com.example.saif.controllers;
...
import com.example.saif.constants.constants;
...
import com.example.saif.utils.CreateAccountInput;
import com.example.saif.utils.InputValidator;
    ...
    public ResponseEntity<?> createAccount(
        ...
        if (InputValidator.isCreateAccountCriteriaValid(createAccountInput)) {
            ...
            Account account = accountService.createAccount(
                    createAccountInput.getBankName(), createAccountInput.getOwnerName(), createAccountInput.getCurrency());
